...
ckpt_dir = 'checkpoints_arch_design_hparams_{}'.format(dataset_ssl)
...
for aidx,arch in enumerate(arch_arr):
	...
	# print(lamda_arr)
	if plot_colorplots:
		plot_colorplot(pdim_arr,lamda_arr,accuracy_dict,"Final accuracy",cmap='coolwarm',vmin=50,vmax=85 if dataset_ssl!=dataset_classifier in dataset_classifier else 90)
