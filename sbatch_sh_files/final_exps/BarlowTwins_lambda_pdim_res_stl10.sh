...
# lambd_arr=(0.04 0.0004 0.04 0.0004 0.008 0.0008 0.002 0.001 0.0008)
lambd_arr=(0.0004 0.0004 0.0004 0.0004 0.0004 0.0004 0.0004 0.0004)
# lambd_arr=(0.02 0.0008 0.001 0.002)
# rewriting the order to make sure the jobs are well distributed
# pdim_arr=(64 8192 128 4096 256 2048 2048 512 1024)
pdim_arr=(64 8192 128 4096 256 2048 512 1024)
# pdim_arr=(128 4096 2048 1024)
# lambd_arr=(0.0004 0.0004 0.0008)
# pdim_arr=(2048 8192 4096)
dataset='stl10'
if [ $dataset = 'stl10' ]
then
    batch_size=400
...
wandb_projname='BarlowTwins-pdim-lambda-result-stl10-v2'
