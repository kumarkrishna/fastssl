...
#SBATCH --error=sbatch_err/multiPatch_barlow_results.%A.%a.err
#SBATCH --job-name=multiPatch_barlow_results

. /etc/profile
module load anaconda/3
conda activate ffcv_new

lambd_arr=(0.02 0.0008 0.01 0.0004 0.01 0.0004)
...
wandb_projname='multiPatch-Barlow-best-hparam-ep100'
