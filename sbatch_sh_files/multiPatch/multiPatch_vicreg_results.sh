...
#SBATCH --output=sbatch_out/multiPatch_vicreg_results.%A.%a.out
#SBATCH --error=sbatch_err/multiPatch_vicreg_results.%A.%a.err
#SBATCH --job-name=multiPatch_vicreg_results

. /etc/profile
module load anaconda/3
conda activate ffcv_new

lambd_arr=(25.0 750.0 25.0)
