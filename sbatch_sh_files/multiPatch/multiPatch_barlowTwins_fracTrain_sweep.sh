#!/usr/bin/env bash
#SBATCH --array=0-39%25
#SBATCH --partition=long
#SBATCH --gres=gpu:rtx8000:1
#SBATCH --mem=16GB
#SBATCH --time=6:00:00
#SBATCH --cpus-per-gpu=4
#SBATCH --output=sbatch_out/multiPatch_barlow_fracTrain_sweep.%A.%a.out
#SBATCH --error=sbatch_err/multiPatch_barlow_fracTrain_sweep.%A.%a.err
#SBATCH --job-name=multiPatch_barlow_fracTrain_sweep
...
wandb_projname='multiPatch-Barlow-sweep-ep100-v2'
