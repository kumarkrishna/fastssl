...
#SBATCH --output=sbatch_out/multiPatch_swav_barlow_stl10_results.%A.%a.out
#SBATCH --error=sbatch_err/multiPatch_swav_barlow_stl10_results.%A.%a.err
#SBATCH --job-name=multiPatch_swav_barlow_stl10_results
...
wandb_projname='multiPatch-swav-Barlow-best-hparam-ep100-stl10'
