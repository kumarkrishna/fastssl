...
#SBATCH --output=sbatch_out/multiPatch_vicreg_fracTrain_sweep.%A.%a.out
#SBATCH --error=sbatch_err/multiPatch_vicreg_fracTrain_sweep.%A.%a.err
#SBATCH --job-name=multiPatch_vicreg_fracTrain_sweep
...
wandb_projname='multiPatch-VICReg-fracTrain-sweep-ep100'

model=resnet50proj

checkpt_dir=$SCRATCH/fastssl/checkpoints_vicreg_mp_fracTrain
