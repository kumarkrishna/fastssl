...
class Imagenet1kTransformFFCV():
    """
    Defines a list of FFCV transforms for SSL on Imagenet-1k
    """
    def __init__(self):
        self.transform_list = [
                                RandomHorizontalFlip(flip_prob=0.5),
                                RandomColorJitter(jitter_prob=0.8,
                                            ...
                                            contrast=0.4,
                                            # saturation=0.4, 
                                            saturation=0.2, # using FFCV-SSL val
                                            hue=0.1),
                                RandomGrayscale(p=0.2),
                                NormalizeImage(mean=np.array(IMAGENET_FFCV_MEAN),
                                        std=np.array(IMAGENET_FFCV_MEAN),
...
class Imagenet1kTransformFFCV_v2():
    """
    Defines a list of FFCV transforms for SSL on Imagenet-1k (second image pipeline)
    """
    def __init__(self):
        self.transform_list = [
                                RandomHorizontalFlip(flip_prob=0.5),
