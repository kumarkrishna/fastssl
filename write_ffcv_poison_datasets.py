...
class PoisonDataset(Dataset):
    def __init__(self, root, baseset, transform=None):
        self.root = root
    ...
    def __getitem__(self, idx):
        ...
        fileidx = self.image_paths[idx].split('/')[-1]
        true_index = int(fileidx.split('.')[0])
        true_img, label = self.baseset[true_index]
        print(idx, label, fileidx, self.classes[label])
        # Open the image file
...
if dataset == "cifar100":
    ...
    dataset_folder = "/home/krishna/data/raw/cifar10"
    # ffcv_folder = "/network/projects/_groups/linclab_users/ffcv/ffcv_datasets/cifar10"
    ffcv_folder = "/home/krishna/data/ffcv/cifar10/clean"
elif dataset == "cifar10p":
    udataset_folder = "/home/krishna/src/github/2024/barl/vision/src/data"
    ffcv_folder="/home/krishna/data/ffcv/cifar10/poison_v2"
    dataset_folder = "/home/krishna/data/raw/cifar10"
...
if dataset == "cifar100":
    ...
    trainset = torchvision.datasets.CIFAR10(
        root=dataset_folder, train=True, download=True, transform=None
    )
    testset = torchvision.datasets.CIFAR10(
        root=dataset_folder, train=False, download=True, transform=None
    )
    ...
    # unlabeledset = PoisonDataset(udataset_folder)
    trainset = torchvision.datasets.CIFAR10(
        root=dataset_folder, train=True, download=True, transform=None)
    unlabeledset = PoisonDataset(udataset_folder, trainset)
    testset = torchvision.datasets.CIFAR10(
        root=dataset_folder, train=False, download=True, transform=None)
...
elif dataset in ["cifar10", "cifar10p"]:
    trainset = torchvision.datasets.CIFAR10(
        root=dataset_folder, train=True, download=False, transform=transform_test
    )
    testset = torchvision.datasets.CIFAR10(
